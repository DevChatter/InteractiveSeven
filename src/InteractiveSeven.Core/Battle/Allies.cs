...
namespace InteractiveSeven.Core.Battle
{
    public class Allies
    {
        ...
        public static Allies Top = new Allies(0, new MemLoc(0x9AB0DC), new MemLoc(0xBF23C0), "top");
        public static Allies Mid = new Allies(1, new MemLoc(0x9AB144), new MemLoc(0xBF2434), "mid", "middle");
        public static Allies Bot = new Allies(2, new MemLoc(0x9AB1AC), new MemLoc(0xBF24A8), "bot", "bottom");
        // Primary Offset 0x68
